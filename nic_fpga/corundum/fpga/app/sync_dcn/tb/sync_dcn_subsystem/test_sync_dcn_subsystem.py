...
compiled-window design: `sync_dcn_subsystem`.
...
from host_control_plane.sync_dcn_program import (
...
async def wait_for_consensus_commit(dut, expected_mask, max_cycles=64):
    ...
    core = dut.sync_dcn_apps_inst.consensus_node_inst.consensus_core_inst
