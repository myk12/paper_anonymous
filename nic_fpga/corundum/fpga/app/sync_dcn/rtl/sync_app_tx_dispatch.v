...
assign o_app_tx_valid = (i_app_valid && i_app_id == `SYNC_DCN_APP_CONSENSUS && i_opcode == `SYNC_DCN_OP_CONS_TX && s_axis_cons_tx_tvalid) ||
    (i_app_valid && i_app_id == `SYNC_DCN_APP_AI_REPLAY && i_opcode == `SYNC_DCN_OP_AI_TX && s_axis_ai_tx_tvalid);
...
always @(*) begin
    ...
    case (i_opcode)
        ...
        `SYNC_DCN_OP_AI_TX: begin
            m_axis_tx_tdata = s_axis_ai_tx_tdata;
            m_axis_tx_tkeep = s_axis_ai_tx_tkeep;
            m_axis_tx_tvalid = i_app_valid && i_app_id == `SYNC_DCN_APP_AI_REPLAY && s_axis_ai_tx_tvalid;
            m_axis_tx_tlast = s_axis_ai_tx_tlast;
            m_axis_tx_tuser = s_axis_ai_tx_tuser;
            s_axis_ai_tx_tready = i_app_valid && i_app_id == `SYNC_DCN_APP_AI_REPLAY && m_axis_tx_tready;
        end
        default: begin
